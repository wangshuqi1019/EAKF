...
function [MSE_list, result_save, result_w, result_beta] = ...
            Flu_dif_period_test(stateNums, mu, S0_tri, param_variance, betamean, betavar, oev, ns)
    addpath('utils/')
    ...
    parfor i_iter = 1:50
        ...
        for i = 1 : nperiod
            ...
            [pf, param] = Flu_filter(Observation(start_time:end_time), param_variance, init_S0, betamean, betavar, oev, ns);
